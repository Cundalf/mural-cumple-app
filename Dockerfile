...
ARG NODE_ENV
# Agregar variables de servidor para el build si es necesario
ARG RECAPTCHA_SECRET_KEY
ARG RECAPTCHA_BYPASS
...
# Variables de servidor para el build
ENV RECAPTCHA_SECRET_KEY=$RECAPTCHA_SECRET_KEY
ENV RECAPTCHA_BYPASS=$RECAPTCHA_BYPASS
